...
[polkadot-v0.9.24](https://github.com/paritytech/substrate/tree/polkadot-v0.9.24).

:information_source: This section is based on
[Substrate node template](https://github.com/substrate-developer-hub/substrate-node-template/tree/polkadot-v0.9.24).
